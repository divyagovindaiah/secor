...
nohup ${JAVA} -ea -Dsecor_group=backup -Dlog4j.configurationFile=log4j2.prod.properties \
...
nohup ${JAVA} -ea -Dsecor_group=partition -Dlog4j.configurationFile=log4j2.prod.properties \
